<template>
  <div id="Welcome">
    <v-card id="GIANT" ref="GIANT">
      <div id="GIANT_BG"
        v-anime-on-itst="{opacity: ['1','0.2'], easing: 'easeOutCubic', duration: '1300'}"></div>
      <div id="TITLE_TEXTS">
        ...
        <div class="SECTION">
          <v-row class="md-6" no-gutters>
            <v-col cols="7">
              ...
              <p>在这里，将编程知识实践。动手制作出正式的项目，积累经验，帮助伱在工作中高人一筹。</p>
            </v-col>
            <v-spacer></v-spacer>
            <v-col cols="4">
              图片
...
export default class Welcome extends Vue
{
  ...
  onMounted() : void{
		...
		//window.addEventListener('resize', () =>{alert("asdfasdf");});
